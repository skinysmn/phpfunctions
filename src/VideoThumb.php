...
class VideoThumb
{
  ...
  protected function foundYoutube($id)
  {
    ...
    $this->id      = $id;
    $this->image   = 'http://img.youtube.com/vi/' . $id . '/hqdefault.jpg';
    $this->video   = 'http://www.youtube.com/watch?v=' . $id;
  ...
  {
	  $data = file_get_contents('https://www.googleapis.com/youtube/v3/videos?key=AIzaSyAI4Ue0k-s_Ozl5gRT8u_Rnf4fTXL7J9A8&part=snippet&id=' . $id);
